  ...
  return (
    <>
      ...
      <button
        ...
        className={`
          inline-flex items-center px-3 py-2 text-sm font-medium text-red-700 
            ...
            >
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  disabled={resetMutation.isPending}
                  className="flex-1 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 transition-colors"
                >
                  Cancel
                </button>
                <button
